...
import { Star, Play, ExternalLink, TrendingUp, Users, Clock, Trophy } from 'lucide-react';
...
export default function SteamRankingCard({ game, rank, onClick }: SteamRankingCardProps) {
  const [imageSrc, setImageSrc] = useState<string>(game.imageUrl || '');
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6 text-xs text-gray-400">
              ...
              {game.genre.includes('Multiplayer') && (
