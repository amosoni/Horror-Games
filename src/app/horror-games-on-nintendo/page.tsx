...
import { Star, TrendingUp, Gamepad2, Trophy, Flame, Award } from 'lucide-react';
...
export default function NintendoGamesPage() {
  ...
  // 筛选 Nintendo Switch 平台的游戏
  const nintendoGames = horrorGames.filter(game => 
    game.platform.includes('Nintendo Switch')
  );
  ...
  const handleSearch = (query: string) => {
    if (!query.trim()) {
      setSearchResults(nintendoGames);
      return;
    }
    
    const filtered = nintendoGames.filter(game =>
  ...
  // 按评分排序
  const sortedGames = [...nintendoGames].sort((a, b) => b.rating - a.rating);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          >
            Discover the best horror games available on Nintendo Switch. From indie horror to AAA titles, 
            find your next scary adventure with our curated rankings.
          </motion.p>
        ...
        >
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-white mb-2">{nintendoGames.length}</div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-yellow-400 mb-2">
              {nintendoGames.length > 0 ? (nintendoGames.reduce((sum, game) => sum + game.rating, 0) / nintendoGames.length).toFixed(1) : '0.0'}
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-green-400 mb-2">
              {nintendoGames.filter(game => game.price === 0).length}
            </div>
        ...
        >
          <div className="flex items-center justify-center mb-12">
            <div className="flex items-center space-x-4 bg-gradient-to-r from-red-600/20 to-pink-600/20 backdrop-blur-sm rounded-2xl px-8 py-4 border border-red-500/30">
              ...
              <h2 className="text-4xl font-bold text-white">Nintendo Switch Horror Games Rankings</h2>
            </div>
          </div>
        ...
        {nintendoGames.length === 0 && (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">No Nintendo Switch Horror Games Found</h3>
