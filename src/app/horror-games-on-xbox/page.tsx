    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Horror Games on Xbox", "item": "https://horrorgames.games/horror-games-on-xbox" }
            ]
          })
        }}
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          >
            Discover the top-rated horror games of 2025 on Xbox. We update this list weekly, selecting games based on Xbox user reviews, 
            critical acclaim, and community buzz. From Series X/S to Xbox One, experience the most terrifying games on Microsoft&apos;s gaming platform.
          </motion.p>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "What are the best horror games on Xbox?", "acceptedAnswer": { "@type": "Answer", "text": "We rank games based on Xbox user reviews, critical scores, and community buzz. Our list includes Series X/S exclusives and Xbox One classics." }},
                { "@type": "Question", "name": "Do these games work on both Xbox One and Series X/S?", "acceptedAnswer": { "@type": "Answer", "text": "Most games are backward compatible. Series X/S exclusives require new consoles, while Xbox One games run better on Series X/S." }},
                { "@type": "Question", "name": "Are these games on Game Pass?", "acceptedAnswer": { "@type": "Answer", "text": "Some are! Check Xbox Game Pass for rotating horror titles. Our rankings include both Game Pass and paid games." }}
              ]
            })
          }}
        />
