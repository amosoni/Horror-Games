...
import { Gamepad2, TrendingUp, Clock, Star, Trophy, Flame, Award } from 'lucide-react';
...
export default function XboxGamesPage() {
  ...
  // 筛选 Xbox 游戏
  const xboxGames = horrorGames.filter(game => 
  ...
  const handleSearch = (query: string) => {
    if (!query.trim()) {
      setSearchResults(xboxGames);
      return;
    }
    
    const filtered = xboxGames.filter(game =>
  ...
  const sortedGames = [...xboxGames].sort((a, b) => {
    switch (sortBy) {
      case 'rating':
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          >
            Discover the best horror games on Xbox. From Xbox One to Xbox Series X/S, experience the most 
            terrifying games on Microsoft's platforms with our curated rankings.
          </motion.p>
        ...
        >
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-white mb-2">{xboxGames.length}</div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-yellow-400 mb-2">
              {xboxGames.length > 0 ? (xboxGames.reduce((sum, game) => sum + game.rating, 0) / xboxGames.length).toFixed(1) : '0.0'}
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-green-400 mb-2">
              {xboxGames.filter(game => game.price === 0).length}
            </div>
        ...
        {xboxGames.length === 0 && (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">No Xbox Horror Games Found</h3>
