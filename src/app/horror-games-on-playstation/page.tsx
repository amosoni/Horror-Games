...
import { Gamepad, TrendingUp, Clock, Star, Trophy, Flame, Award, RefreshCw, AlertCircle } from 'lucide-react';
import { useRawgPlayStationHorror } from '../../hooks/useRawgGames';
...
export default function PlayStationGamesPage() {
  ...
  // 使用 RAWG PlayStation 数据 Hook
  const { 
    games: playstationGames, 
    loading, 
    error, 
    refresh
  } = useRawgPlayStationHorror({
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Horror Games on PlayStation", "item": "https://horrorgames.games/horror-games-on-playstation" }
            ]
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            "name": "PlayStation Horror Games 2025",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <motion.h1 
            className="text-5xl md:text-7xl font-bold text-white mb-8 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-600 bg-clip-text text-transparent"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
          >
            PlayStation Horror Games of 2025 Rankings
          </motion.h1>
          ...
          >
            Discover the top-rated horror games of 2025 on PlayStation. We update this list weekly, selecting games based on PlayStation user reviews, 
            critical acclaim, and community buzz. From PS5 exclusives to PS4 classics, experience the most terrifying games on Sony&apos;s gaming platform.
          </motion.p>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-600/20 to-indigo-600/20 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30">
            <div className="flex items-center space-x-3">
              <Flame className="text-purple-500 w-8 h-8" />
              <div>
          ...
          <div className="bg-gradient-to-r from-indigo-600/20 to-blue-600/20 backdrop-blur-sm rounded-2xl p-6 border border-indigo-500/30">
            <div className="flex items-center space-x-3">
              <Award className="text-indigo-500 w-8 h-8" />
              <div>
                <p className="text-2xl font-bold text-white">
        ...
        {loading && (
          ...
          >
            <div className="inline-flex items-center space-x-2 text-gray-400">
              ...
              <span>Loading PlayStation horror games...</span>
            </div>
          </motion.div>
        )}
          ...
          >
            <div className="flex items-center justify-center mb-12">
              <div className="flex items-center space-x-4 bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-2xl px-8 py-4 border border-blue-500/30">
                <Trophy className="text-blue-500 w-8 h-8" />
                <h2 className="text-4xl font-bold text-white">PlayStation Horror Games of 2025 Rankings</h2>
              </div>
            </div>
        ...
        {!loading && !error && sortedGames.length === 0 && (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">
              {searchQuery ? 'No Games Found' : 'No PlayStation Horror Games Found'}
            </h3>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "What are the best horror games on PlayStation?", "acceptedAnswer": { "@type": "Answer", "text": "We rank games based on PlayStation user reviews, critical scores, and community buzz. Our list includes PS5 exclusives, PS4 classics, and VR horror." }},
                { "@type": "Question", "name": "Do these games work on both PS4 and PS5?", "acceptedAnswer": { "@type": "Answer", "text": "Most games are backward compatible. PS5 exclusives require PS5, while many PS4 games run better on PS5." }},
                { "@type": "Question", "name": "Are there PlayStation VR horror games?", "acceptedAnswer": { "@type": "Answer", "text": "Yes! We include VR horror games in our rankings. Check the VR category for immersive horror experiences." }}
              ]
            })
          }}
        />
