...
import { Star, TrendingUp, Users, Gamepad2, Trophy, Flame, Award } from 'lucide-react';
...
export default function RobloxGamesPage() {
  ...
  // 筛选 Roblox 游戏（这里需要添加Roblox游戏数据）
  const robloxGames = horrorGames.filter(game => 
    game.platform.includes('Roblox') || game.tags.includes('roblox')
  );
  ...
  // 按评分排序
  const sortedGames = [...robloxGames].sort((a, b) => b.rating - a.rating);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          >
            Discover the best horror games on Roblox. Play with friends in terrifying multiplayer 
        ...
        >
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-white mb-2">{robloxGames.length}</div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-yellow-400 mb-2">
              {robloxGames.length > 0 ? (robloxGames.reduce((sum, game) => sum + game.rating, 0) / robloxGames.length).toFixed(1) : '0.0'}
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-3xl p-8 text-center border border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300">
            ...
            <div className="text-4xl font-bold text-green-400 mb-2">
              {robloxGames.filter(game => game.genre.includes('Multiplayer')).length}
            </div>
        ...
        {robloxGames.length === 0 && (
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-white mb-4">No Roblox Horror Games Found</h3>
